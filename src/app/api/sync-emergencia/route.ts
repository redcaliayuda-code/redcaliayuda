...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    for (const p of acopios) {
      ...
      if (existingCenterNames.has(nombre)) continue;
    ...
    return NextResponse.json({
      ...
      nuevasNecesidades: needsCreated,
      nuevosCentros: centersCreated,
      totalNecesidades: totalNeeds,
      totalCentros: totalCenters,
    });
  } catch (err: any) {
    return NextResponse.json(
