                ...
                <div className="mt-3 flex gap-2">
                  <a
                    href={`https://wa.me/57${n.contactoCelular}?text=${encodeURIComponent(
                      `Hola ${n.contactoNombre}, soy voluntario de HumansCol. Vi tu necesidad de ${(CAT_NOMBRE[n.categoria] ?? n.categoria).toLowerCase()} en ${n.zona || n.ciudad}. ¿Cómo puedo ayudarte?`
                    )}`}
                    target="_blank"
